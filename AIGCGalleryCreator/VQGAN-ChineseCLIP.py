...
vq_parser.add_argument("-m", "--clip_model", type=str, help="CLIP模型选择（可选'ViT-B-16', 'ViT-L-14', 'ViT-L-14-336', 'ViT-H-14', 'RN50'）", default='ViT-B-16', dest='clip_model')
...
# 加载CLIP，评估模式且禁用梯度
perceptor = clip.load_from_name(args.clip_model, device=device,
                                download_root='./checkpoints')[0].eval().requires_grad_(False).to(device)
...
# 完成文生图过程
# Modified from https://github.com/nerdyrodent/VQGAN-CLIP
# 2025.1.12
